...
export function useDeployedContractInfo<TContractName extends ContractName>(
  ...
  const deployedContract = (contracts as Record<string, Record<ContractName, Contract<any>>>)[String(selectedNetwork.id)]?.[contractName as ContractName] as Contract<TContractName>;
